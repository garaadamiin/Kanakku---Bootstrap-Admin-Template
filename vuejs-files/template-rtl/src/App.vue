  ...
  name: 'App',
    ...
    return false;
        ...
        '<ul class="sticky-sidebar siderbar-view">' +
            ...
            '</li>' +
            '<li class="sidebar-icons">' +
                 '<a class="toggle tipinfo open-settings open-siderbar" href="javascript:void(0)" data-toggle="tooltip" data-placement="left" data-bs-original-title="Tooltip on left">' +
                     '<div class="tooltip-five">' +
