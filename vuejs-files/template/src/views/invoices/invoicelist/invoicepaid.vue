											...
											<tbody>
												<tr v-for="item in invoicepaid" :key="item.id">
													<td>
														...
														<router-link to="/view-invoice" class="invoice-link">IN093439#@09</router-link>
													</td>
													<td>16 Mar 2022</td>
													<td>
														<h2 class="table-avatar">
															<router-link to="/profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" :src="loadImg(item.img)" alt="User Image"> Barbara Moore</router-link>
														</h2>
													</td>
