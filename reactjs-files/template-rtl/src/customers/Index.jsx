...
const Customers = () => {
	...
	const columns = [
																										
		{
			name: 'Customer',			
			sortable: true,
			cell: row => <Media ><Media.Body className="d-flex"><a href="/profile" className="avatar avatar-sm ms-2 user-dt"><img src={row.img_url} className="avatar-img rounded-circle" /></a><div className='mobilenumber'>{row.Customer}<span>9876543210</span></div></Media.Body></Media>,
			width:"250px",
		},
		{
			name: 'Email',
		...
		},
		{
			...
			sortable: true,
			cell: () => <div className='d-flex text-start'><a href="/edit-customer" className="btn btn-sm btn-white text-success ms-2 "><i className="far fa-edit ms-1"></i> Edit</a><a href="#;" className="btn btn-sm btn-white text-danger ms-2 "><i className="far fa-trash-alt ms-1"></i>Delete</a> </div>,
			width:"250px",
		},
					...
					<div className="page-header">
						<div className="row align-items-center">
							...
							<div className="col-auto">
								<Link to="/add-customer" className="btn btn-primary ms-1">
