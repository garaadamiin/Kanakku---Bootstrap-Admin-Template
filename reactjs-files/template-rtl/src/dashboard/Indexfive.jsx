...
import Sidebarfive from '../layouts/Sidebarfive'
...
const Indexfive = () => {
	...
	const salesOptions= {
        ...
        return (
			...
			<div className={`main-wrapper container${menu ? 'main-wrapper container slide-nav': ''}`}> 
          
              <Headerfive onMenuClick={(value) => toggleMobileMenu()} />
             <Sidebarfive />
										...
										<table className="table table-hover">
											...
											{recentestimates_.map((item, index) => {
												...
												<tr key={index}>
													<td>
														<h2 className="table-avatar">
															<a href="/profile"><img className="aavatar avatar-sm me-2 avatar-img rounded-circle" src={item.image} alt="User Image" />{item.customer_name}</a>
														</h2>
													</td>
													...
													<td className="text-end">
														<div className="dropdown dropdown-action">
															...
															<div className="dropdown-menu dropdown-menu-right">
																...
																<a className="dropdown-item" href="#"><i className="far fa-file-alt me-2"></i>Convert to Invoice</a>
																<a className="dropdown-item" href="#"><i className="far fa-check-circle me-2"></i>Mark as sent</a>
																<a className="dropdown-item" href="#"><i className="far fa-paper-plane me-2"></i>Send Estimate</a>
																<a className="dropdown-item" href="#"><i className="far fa-check-circle me-2"></i>Mark as Accepted</a>
																<a className="dropdown-item" href="#"><i className="far fa-times-circle me-2"></i>Mark as Rejected</a>
															</div>
														</div>
													</td>
												</tr>
