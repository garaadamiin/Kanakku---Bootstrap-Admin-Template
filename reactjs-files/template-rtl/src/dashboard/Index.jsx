						...
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-danger ms-1"><i className="fas fa-arrow-down ms-1"></i>1.15%</span> since last week</p>
								</div>
							</div>
						</div>
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-success ms-1"><i className="fas fa-arrow-up ms-1"></i>2.37%</span> since last week</p>
								</div>
							</div>
						</div>
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-success ms-1"><i className="fas fa-arrow-up ms-1"></i>3.77%</span> since last week</p>
								</div>
							</div>
						</div>
						<div className="col-xl-3 col-sm-6 col-12">
							<div className="card">
								<div className="card-body">
									...
									<p className="text-muted mt-3 mb-0"><span className="text-danger ms-1"><i className="fas fa-arrow-down ms-1"></i>8.68%</span> since last week</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div className="card-header">
									<div className="d-flex justify-content-between align-items-center">
										...
										<div className="dropdown" data-bs-toggle="dropdown">
											<a href="#" className="btn btn-white btn-sm dropdown-toggle" role="button" data-bs-toggle="dropdown">
												Monthly
											</a>
									...
									<div className="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap">
										<div className="w-md-100 d-flex align-items-center mb-3 flex-wrap">
											<div>
												...
												<p className="h3 text-primary ms-5">$1000</p>
											</div>
											<div>
												<span>Receipts</span>
												<p className="h3 text-success ms-5">$1000</p>
											</div>
											<div>
												<span>Expenses</span>
												<p className="h3 text-danger ms-5">$300</p>
											</div>
											<div>
												<span>Earnings</span>
												<p className="h3 text-dark ms-5">$700</p>
											</div>
										</div>
									</div>
								...
								<div className="card-body">
									...
									<div className="text-center text-muted">
										<div className="row">
											<div className="col-4">
												<div className="mt-4">
													<p className="mb-2 text-truncate"><i className="fas fa-circle text-primary ms-1"></i> Invoiced</p>
													<h5>$ 2,132</h5>
												</div>
											</div>
											<div className="col-4">
												<div className="mt-4">
													<p className="mb-2 text-truncate"><i className="fas fa-circle text-success ms-1"></i> Received</p>
													<h5>$ 1,763</h5>
												</div>
											</div>
											<div className="col-4">
												<div className="mt-4">
													<p className="mb-2 text-truncate"><i className="fas fa-circle text-danger ms-1"></i> Pending</p>
													<h5>$ 973</h5>
												</div>
											</div>
										</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="mb-3">
										...
										<div className="row">
											<div className="col-auto">
												<i className="fas fa-circle text-success ms-1"></i> Paid
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-warning ms-1"></i> Unpaid
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-danger ms-1"></i> Overdue
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-info ms-1"></i> Draft
											</div>
										</div>
									</div>
												...
												<tr key={index}>
													<td>
														<h2 className="table-avatar">
															<Link to="/profile"><img className="aavatar avatar-sm ms-2 avatar-img rounded-circle" src={item.image} alt="User Image" />{item.customer_name}</Link>
														</h2>
													</td>
													<td>{item.amount}</td>
													<td>{item.due_date}</td>
													...
													<td className="text-end">
														<div className="dropdown dropdown-action">
															...
															<div className="dropdown-menu dropdown-menu-right">
																<Link className="dropdown-item" to="/edit-invoice"><i className="far fa-edit ms-2"></i>Edit</Link>
																<Link className="dropdown-item" to="/view-invoice"><i className="far fa-eye ms-2"></i>View</Link>
																<a className="dropdown-item" href=""><i className="far fa-trash-alt ms-2"></i>Delete</a>
																<a className="dropdown-item" href=""><i className="far fa-check-circle ms-2"></i>Mark as sent</a>
																<a className="dropdown-item" href=""><i className="far fa-paper-plane ms-2"></i>Send Invoice</a>
																<a className="dropdown-item" href=""><i className="far fa-copy ms-2"></i>Clone Invoice</a>
															</div>
														</div>
													</td>
												</tr>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="mb-3">
										...
										<div className="row">
											<div className="col-auto">
												<i className="fas fa-circle text-success ms-1"></i> Sent
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-warning ms-1"></i> Draft
											</div>
											<div className="col-auto">
												<i className="fas fa-circle text-danger ms-1"></i> Expired
											</div>
										</div>
									</div>
									<div className="table-responsive">
										<table className="table table-hover">
											...
											{recentestimates_.map((item, index) => {
												...
												<tr key={index}>
													<td>
														<h2 className="table-avatar">
															<a href="/profile"><img className="aavatar avatar-sm ms-2 avatar-img rounded-circle" src={item.image} alt="User Image" />{item.customer_name}</a>
														</h2>
													</td>
													...
													<td className="text-end">
														<div className="dropdown dropdown-action">
															...
															<div className="dropdown-menu dropdown-menu-right">
																<Link className="dropdown-item" to="/edit-invoice"><i className="far fa-edit ms-2"></i>Edit</Link>
																<a className="dropdown-item" href="#"><i className="far fa-trash-alt ms-2"></i>Delete</a>
																<Link className="dropdown-item" to="/view-estimate"><i className="far fa-eye ms-2"></i>View</Link>
																<a className="dropdown-item" href="#"><i className="far fa-file-alt ms-2"></i>Convert to Invoice</a>
																<a className="dropdown-item" href="#"><i className="far fa-check-circle ms-2"></i>Mark as sent</a>
																<a className="dropdown-item" href="#"><i className="far fa-paper-plane ms-2"></i>Send Estimate</a>
																<a className="dropdown-item" href="#"><i className="far fa-check-circle ms-2"></i>Mark as Accepted</a>
																<a className="dropdown-item" href="#"><i className="far fa-times-circle ms-2"></i>Mark as Rejected</a>
															</div>
														</div>
													</td>
												</tr>
