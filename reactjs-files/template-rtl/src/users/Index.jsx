	...
	const columns = [      																							
		{
			name: 'Name',			
			sortable: true,
			cell: row => <Media className="user-dt"><a href="/profile" className="avatar avatar-sm ms-2"><img src={row.img_url} className="avatar-img rounded-circle" /></a><Media.Body>{row.Name}</Media.Body></Media>,
            width:"250px",
		},
		{
			name: 'Email',
