					...
					<div className="page-header">
						<div className="row align-items-center">
							...
							<div className="col-auto text-end float-end ms-auto">
                                <a href="#" onClick = {() => setshowmodel ("showEvents")} className="btn btn-primary"  >Create Event</a>
					...
					<div className="row">
						<div className="col-lg-3 col-md-4">
							...
							<div className="checkbox  mb-3">
								...
								<label className='me-1'>Remove after drop</label>
							</div>
                            <a href="#0" onClick = {() => setshowmodel("showCategory")} className="btn mb-3 btn-primary btn-block w-100 w-100">
