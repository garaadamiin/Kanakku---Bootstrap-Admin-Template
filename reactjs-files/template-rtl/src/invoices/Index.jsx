	...
	const columns = [		
		...
		},	
		{
			...
			<div className="dropdown-menu dropdown-menu-right">
				<a className="dropdown-item" href="/edit-invoice"><i className="far fa-edit me-2"></i>Edit</a>
				<a className="dropdown-item" href="/view-invoice"><i className="far fa-eye me-2"></i>View</a>
