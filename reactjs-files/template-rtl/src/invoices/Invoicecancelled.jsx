...
const Invoicecancelled = () => {
	...
	const columns = [		
		...
		},																																						
		{
			name: 'Invoice to',			
			sortable: true,
			cell: row => <Media className="user-dt"><a href="/profile" className="avatar avatar-sm ms-2"><img src={row.img_url} className="avatar-img rounded-circle" /></a><Media.Body>{row.Invoiceto}</Media.Body></Media>,
			width:"250px",
		},
		...
		
		{
			...
			sortable: true,
			cell: () => <div><a href="/edit-customer" className="btn btn-sm btn-white text-success ms-2"><i className="far fa-edit me-1"></i> Edit</a><a href="#;" className="btn btn-sm btn-white text-danger ms-2"><i className="far fa-trash-alt me-1"></i>Delete</a> </div>,
			width:"250px",
		},
									...
									<div className="col-lg-8 col-md-8">
										<div className="invoices-tabs">
											<ul>
												...
												<li><Link to="/invoice-cancelled" className="active">Cancelled</Link ></li>
											</ul>
										</div>
									</div>
