													...
													<tbody>
														<tr className="add-row">
															...
															<td className="add-remove text-end">
																<Link to="javascript:void(0);" className="add-btn ms-2"><i className="fas fa-plus-circle"></i></Link > 
																<Link to="#" className="copy-btn ms-2"><i className="fe fe-copy"></i></Link ><Link to="javascript:void(0);" className="remove-btn"><i className="fe fe-trash-2"></i></Link >
															</td>
														</tr>
													</tbody>
												</table>
											...
											<div className="col-lg-7 col-md-6">
												<div className="invoice-fields">
													...
													<div className="field-box">
														<p>Payment Details</p>
														<Link className="btn btn-primary" to="#" data-bs-toggle="modal" data-bs-target="#bank_details"><i className="fas fa-plus-circle ms-2"></i>Add Bank Details</Link >
													</div>
												</div>
					...
					<div className="modal-content">
						...
						<div className="modal-footer">
							<div className="bank-details-btn">
								<Link to="javascript:void(0);" data-bs-dismiss="modal" className="btn bank-cancel-btn ms-2">Cancel</Link >
