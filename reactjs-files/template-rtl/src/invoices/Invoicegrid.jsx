										...
										<li>
											<div className="report-btn">
												<Link to="#" className="btn">
													<img src={icon5} alt="" className="ms-2"/> Generate report
												</Link >
											</div>
										</li>
									</ul>
					...
					<div className="row">
								...
								<div className="card-header d-flex justify-content-between align-items-center">
									...
									<div className="dropdown dropdown-action">
										...
										<div className="dropdown-menu dropdown-menu-end">
											...
											<Link className="dropdown-item" to ="/invoice-details"><i className="far fa-eye ms-2"></i>View</Link>
											<Link className="dropdown-item" to ="javascript:void(0);"><i className="far fa-trash-alt ms-2"></i>Delete</Link>
										</div>
									</div>
								</div>
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img4} alt="User Image"/> Barbara Moore</Link>
									</h2>
								</div>
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img6} alt="User Image"/> Karlene Chaidez</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img8} alt="User Image"/> Russell Copeland</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img10} alt="User Image"/> Joseph Collins</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img11} alt="User Image"/> Jennifer Floyd</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img9} alt="User Image"/> Leatha Bailey</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img12} alt="User Image"/> Alex Campbell</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
						...
						<div className="col-sm-6 col-lg-4 col-xl-3 d-flex">
							<div className="card invoices-grid-card w-100">
								...
								<div className="card-middle">
									<h2 className="card-middle-avatar">
										<Link to="/profile"><img className="avatar avatar-sm ms-2 avatar-img rounded-circle" src={img3} alt="User Image"/> Marie Canales</Link>
									</h2>
								</div>
								<div className="card-body">
									<div className="row align-items-center">
