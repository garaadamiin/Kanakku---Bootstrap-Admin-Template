...
const Invoiceoverdue = () => {
	...
	const columns = [		
		{
			name: 'Invoice ID',
			selector: row=> <Media><label class="custom_check"><input type="checkbox" name="invoice"/><span class="checkmark"></span> </label><Link to="/invoice-details">{row.InvoiceID}</Link></Media>,
			sortable: true,		
			width:"250px",						
		},	
		...
		},
		{
			...
			sortable: true,	           
			cell: row => <Media className="user-dt"><span className= "badge badge-pill badge  bg-danger-light" >{row.status}</span><Media.Body></Media.Body></Media>,
			width:"250px",		
		},	
		{
			name: 'Action',
									...
									<div className="col-lg-8 col-md-8">
										<div className="invoices-tabs">
											<ul>
												...
												<li><Link to="/invoice-overdue" className="active">Overdue</Link ></li>		
