...
const Invoicerecurring = () => {
	...
	const columns = [		
		{
			name: 'Invoice number',
			selector: row=> <Media><label class="custom_check"><input type="checkbox" name="invoice"/><span class="checkmark"></span> </label><Link to="/invoice-details">{row.Invoicenumber}</Link></Media>,
			sortable: true,		
			width:"250px",						
		},		
		{
		...
		},																																		
		{
			name: 'Invoice to',			
			sortable: true,
			cell: row => <Media className="user-dt"><Link to="/profile" className="avatar avatar-sm ms-2"><img src={row.img_url} className="avatar-img rounded-circle" /></Link><Media.Body>{row.Invoiceto}</Media.Body></Media>,
			width:"250px",
		},
		...
		{
			name: 'Last invoice',
			selector: row=>row.Lastinvoice,
			sortable: true,
			width:"250px",
		},
		{
			name: 'Nextinvoice',
			selector: row=>row.Nextinvoice,
			sortable: true,
			width:"250px",
		},
		{
		...
		},
		{
			...
			sortable: true,	           
			cell: row => <Media className="user-dt"><span className={`badge badge-pill badge ${ row.status == "Active" ? 'bg-success-dark' : 'bg-danger-dark' }`} >{row.status}</span><Media.Body></Media.Body></Media>,
			width:"250px",		
		},		
		{
			name: 'Action',
			...
			sortable: true,
			cell: () => <div><Link to="/edit-customer" className="btn btn-sm btn-white text-success ms-2"><i className="far fa-edit me-1"></i> Edit</Link><a href="#;" className="btn btn-sm btn-white text-danger ms-2"><i className="far fa-trash-alt me-1"></i>Delete</a> </div>,
			width:"250px",
		},
									...
									<div className="col-lg-8 col-md-8">
										<div className="invoices-tabs">
											<ul>
												...
												<li><Link to="/invoice-recurring" className="active">Recurring</Link ></li>
