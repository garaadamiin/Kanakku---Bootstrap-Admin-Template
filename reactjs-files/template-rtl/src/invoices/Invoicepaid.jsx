...
const Invoicepaid = () => {
	...
	const columns = [		
		...
		},
		{
			...
			sortable: true,	           
			cell: row => <Media className="user-dt"><span className={`badge badge-pill badge ${ row.status == "Paid" ? 'bg-success-light' : row.status == "Partially Paid" ? 'bg-warning-light' : row.status == "Sent" ? 'bg-info-light':'bg-danger-light' }`} >{row.status}</span><Media.Body></Media.Body></Media>,
			width:"250px",		
		},	
		{
			name: 'Action',
			...
			sortable: true,
			cell: () => <div><Link to="/edit-invoice" className="btn btn-sm btn-white text-success ms-2"><i className="far fa-edit me-1"></i> Edit</Link><a href="#;"  data-bs-toggle="modal" data-bs-target="#delete_paid" className="btn btn-sm btn-white text-danger ms-2"><i className="far fa-trash-alt me-1"></i>Delete</a> </div>,
			width:"250px",
									...
									<div className="col-lg-8 col-md-8">
										<div className="invoices-tabs">
											<ul>
												...
												<li><Link to="/invoice-paid" className="active">Paid</Link ></li>	
