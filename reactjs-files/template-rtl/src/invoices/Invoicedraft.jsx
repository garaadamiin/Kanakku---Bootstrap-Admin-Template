...
const Invoicedraft = () => {
	...
	const columns = [		
																																					
		{
			name: 'Invoice to',			
			sortable: true,
			cell: row => <Media className="user-dt"><label class="custom_check"><input type="checkbox" name="invoice"/><span class="checkmark"></span> </label><Link to="/profile" className="avatar avatar-sm ms-2"><img src={row.img_url} className="avatar-img rounded-circle" /></Link><Media.Body>{row.Invoiceto}</Media.Body></Media>,			
		},
