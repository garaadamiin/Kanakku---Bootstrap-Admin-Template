													...
													<tbody>
														<tr className="table-form-control add-row">
															...
															<td className="add-remove text-end">
																<a href="javascript:void(0);" className="add-btn ms-2"><i className="fas fa-plus-circle"></i></a> 
																<a href="#" className="copy-btn ms-2"><i className="fe fe-copy"></i></a><a href="javascript:void(0);" className="remove-btn"><i className="fe fe-trash-2"></i></a>
															</td>
														</tr>
														<tr className="table-form-control add-row">
															<td>
												...
												<div className="invoice-total-card">
													...
													<div className="invoice-total-box">
														<div className="invoice-total-inner">
															...
															<a href="javascript:void(0);" className="add-links">
