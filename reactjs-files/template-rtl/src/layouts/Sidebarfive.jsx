...
const [isSideMenu, setSideMenu] = useState("")
    ...
    console.log("Working", isSideMenu)
        ...
        return(
                ...
                <div className="sidebar sidebar-four sidebar-hide" id="sidebar">
					<Scrollbars      
                    autoHide
                ...
                <div className="sidebar-inner slimscroll">
                    <div id="sidebar-menu" className="sidebar-menu sidebar-menu-four">
                        <ul>
...
export default withRouter(Sidebarfive);