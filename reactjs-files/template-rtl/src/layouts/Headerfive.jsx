			...
			{/* /Logo */}
				...
				<ul className="nav user-menu nav nav-tabs user-menu user-menu-four">				
					<li className="nav-item dropdown has-arrow flag-nav">
						<a className="nav-link dropdown-toggle dropdown-toggle-four" data-bs-toggle="dropdown" href="#" role="button">
							<img src={UsFlag} alt="" height="20" /> <span className='ms-2'>English</span>
						</a>
					...
					<li className="nav-item dropdown">
						<a href="#" className="dropdown-toggle dropdown-toggle-four nav-link" data-bs-toggle="dropdown">
					...
					<li className="nav-item dropdown has-arrow main-drop">
						<a href="#" className="dropdown-toggle nav-link dropdown-toggle-four" data-bs-toggle="dropdown">
