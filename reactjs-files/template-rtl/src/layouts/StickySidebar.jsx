...
import {sidebar_icon1,sidebar_icon2,sidebar_icon3,Logo,sidebar_deleteicon,demo_one,demo_three,demo_two,demo_four,demo_five,reset_icon,layout_one,layout_two,layout_three,layout_four,layout_five} from "../_components/imagepath"
import $ from 'jquery'
...
<>
  ...
  <div className="right-side-views">
    ...
    <ul className={`sticky-sidebar siderbar-view  ${task || setting ? "show-sidebar" : "" }`}>
      ...
      <li  className="sidebar-icons">
        ...
        >
          ...
          <div className="tooltip-five  " onClick= {() => ontaskClick("settings")} >
  ...
  <div  className={`sidebar-layout show-layout offcanvas offcanvas-start ${task ? 'show': ''}`} id="demo" >
        ...
        <div className="container-fluid">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-6 col-sm-6 col-12">
              ...
              <a className="btn-closed btn" href="#" type="button" onClick={() => setTask(false)}>
                <img
                  className="img-fliud"
  ...
  <div  className={`sidebar-settings show-layout siderbar-view sidebar-layout offcanvas offcanvas-start ${setting ? 'show': ''}`} id="settings" >
        ...
        <div className="container-fluid">
          ...
          <div className="row align-items-center ">
            ...
            <div className="col-xl-6 col-sm-6 col-12">
              ...
              <a className="btn-closed btn" href="#"  type="button" onClick={() => setsetting(false)}>
                <img
                  className="img-fliud"
                  src={sidebar_deleteicon}
                  alt="demo"
            ...
            <div className="row">
              ...
              <div className="col-lg-6 setting">
                ...
                <label className="switch switch-one">
                  <a href ="https://kanakku-react.dreamguystech.com/template/index" className="layout-link" />
            ...
            <div className="row">
              ...
              <div className="col-lg-6 setting">
                ...
                <label className="switch switch-one">
                  ...
                  <a
                    href="https://kanakku-react.dreamguystech.com/template-rtl/index"
        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-6 col-sm-6">
            ...
            <div className="sidebar-color-one align-center">
              ...
              <span className="color-four" /><span className="color-six" />
          ...
          <div className="col-xl-6 col-sm-6">
            ...
            <div className="sidebar-color-one align-center">
              <span className="color-five" />
              <span className="color-two" /><span className="color-six" />
