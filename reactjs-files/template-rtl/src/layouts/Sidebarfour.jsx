...
const [isSideMenu, setSideMenu] = useState("")
    ...
    console.log("Working", isSideMenu)
        ...
        return(
            ...
            <div className="sidebar sidebar-three" id="sidebar">
					<Scrollbars      
                    autoHide
                ...
                <div className="sidebar-inner slimscroll">
                    ...
                    <ul className="tab nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <a className="tablinks nav-link active" href="#home" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" role="tab" aria-controls="home" aria-selected="true">
                            <FeatherIcon icon="airplay" />
                        </a>
                        </li>
                        <li className="nav-item" role="presentation">
                        <a className="tablinks nav-link" id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages" role="tab" aria-controls="messages" aria-selected="false">
                            <FeatherIcon icon="layers" />              
                        </a>
                        </li>
                        <li className="nav-item" role="presentation">
                        <a className="tablinks nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" role="tab" aria-controls="profile" aria-selected="false" >
                            <FeatherIcon icon="file" />
                        </a>
                        </li>
                        <li className="nav-item" role="presentation">
                        <Link className="tablinks nav-link" to="/chat">
                        <FeatherIcon icon="message-square" />           
                        </Link>
                        </li>
                        <li className="nav-item" role="presentation">
                        <Link className="tablinks nav-link" to="/inbox">
                        <FeatherIcon icon="mail" />            
                        </Link>
                        </li>
                        <li className="nav-item" role="presentation">
                        <Link className="tablinks nav-link" to="/calendar">
                        <FeatherIcon icon="calendar" />
                        </Link>
                        </li>
                    </ul>
                    </aside> <div className="tab-content tab-content-three">
                    <ul className="tab-pane active" id="home" aria-labelledby="home-tab">
                       
                            <li className="menu-title menu-title-three"><span>Main</span></li>
                        ...
                        <ul className="tab-pane" id="messages" aria-labelledby="messages-tab">
                        <li id="inter" className="menu-title menu-title-three"> 
                        ...
                        <ul className="tab-pane" id="profile" aria-labelledby="profile-tab">
								<li className="menu-title menu-title-three"> 
                            </li>
...
export default withRouter(Sidebarfour);