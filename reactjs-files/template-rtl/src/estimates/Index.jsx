...
const Estimates = () => {
	...
	const columns = [
	
			{
				...
				sortable: true,
				cell: () => <a href="/view-estimate">EST-17ER281</a>,
				width:"250px",						
			},									
																										
		{
			name: 'Customer',			
			sortable: true,
			cell: row => <Media className="user-dt"><a href="/profile" className="avatar avatar-sm"><img src={row.img_url} className="avatar-img rounded-circle" /></a><Media.Body className="me-2">{row.Customer}</Media.Body></Media>,
			width:"250px",
		},
		{
			name: 'Estimate Date',
		...
		},
		{
			...
			<a href="#" className="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i className="fas fa-ellipsis-h"></i></a>
			<div className="dropdown-menu dropdown-menu-right">
				<a className="dropdown-item" href="#"><i className="far fa-edit ms-2"></i>Edit</a>
				<a className="dropdown-item" href="#"><i className="far fa-trash-alt ms-2"></i>Delete</a>
				<a className="dropdown-item" href="/view-estimate"><i className="far fa-eye ms-2"></i>View</a>
					...
					<div className="page-header">
						<div className="row align-items-center">
							...
							<div className="col-auto">
								<Link to="/add-estimate" className="btn btn-primary ms-1">
									<i className="fas fa-plus"></i>
								</Link>
								<a className="btn btn-primary filter-btn" href="/estimates#" id="filter_search">
