								...
								<div className="card-header">
									<div className="row">
										...
										<div className="col-auto">
											<a href="#" className="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#add_category">Add New Category</a>
										</div>
									</div>
								</div>
											...
											<tbody>
												<tr>
													...
													<td className="text-end">
														<a href="#" data-bs-toggle="modal" data-bs-target="#edit_category" className="btn btn-sm btn-white text-success ms-2"><i className="far fa-edit ms-1"></i> Edit</a> 
														<a href="#" data-bs-toggle="modal" data-bs-target="#delete_category" className="btn btn-sm btn-white text-danger ms-2"><i className="far fa-trash-alt ms-1"></i>Delete</a>
													</td>
												</tr>
												<tr>
													<td>Sales</td>
