                            ...
                            <div className="col-sm-12">
                                ...
                                <div className="card">
                                    ...
                                    <p className="card-text">
                                        ...
                                        validation{" "}
                                        <a href="https://getbootstrap.com/docs/4.1/components/forms/#server-side" target="_blank">                                        
                                    ...
                                    <div className="row">
                                        ...
                                        <form className="needs-validation" noValidate>
                                            ...
                                            <div className="col-md-4 mb-3">
                                                ...
                                                <input
                                                    type="text" className="form-control" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" required/>                                                 
