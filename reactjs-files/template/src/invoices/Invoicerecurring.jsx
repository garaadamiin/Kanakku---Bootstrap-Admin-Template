...
const Invoicerecurring = () => {
	...
	const columns = [		
		{
			name: 'Invoice number',
			selector: row=> <Media><label className="custom_check"><input type="checkbox" name="invoice"/><span className="checkmark"></span> </label><Link to="/invoice-details">{row.Invoicenumber}</Link></Media>,
			sortable: true,		
			width:"250px",						
		},		
		{
		...
		},		
		{
			...
			sortable: true,
			cell: () => <div><Link to="/edit-customer" className="btn btn-sm btn-white text-success me-2"><i className="far fa-edit me-1"></i> Edit</Link><a href="#;" className="btn btn-sm btn-white text-danger me-2"><i className="far fa-trash-alt me-1"></i>Delete</a> </div>,
			width:"250px",
		},
