											...
											<tbody>
												<tr>
													...
													<td className="text-end">
														<a href="#" data-bs-toggle="modal" data-bs-target="#edit_category" className="btn btn-sm btn-white text-success me-2"><i className="far fa-edit me-1"></i> Edit</a> 
														<a href="#" data-bs-toggle="modal" data-bs-target="#delete_category" className="btn btn-sm btn-white text-danger me-2"><i className="far fa-trash-alt me-1"></i>Delete</a>
													</td>
												</tr>
												<tr>
													<td>Sales</td>
