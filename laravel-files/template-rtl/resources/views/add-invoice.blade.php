...
@section('content')		
	@section('css')
		...
		<!-- feather CSS -->
		<link rel="stylesheet" href="{{url('assets/libs/feather/feather.css')}}">
	@endsection 
				<!-- Page Header -->
											...
											<div class="row">
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="invoice-info">
														<strong class="customer-text">Invoice From <a class="small" href="{{url('edit-invoice')}}">Edit Address</a></strong>
