						...
						<table class="table table-stripped table-center table-hover datatable">
							...
							<tbody>
								<tr>
									<td>
										<h2 class="table-avatar">
											<a href="{{url('profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ URL::asset('/assets/img/profiles/avatar-01.jpg')}}" alt="User Image"> Charles Hafner</a>
										</h2>
									</td>
								...
								<tr>
									<td>
										<h2 class="table-avatar">
											<a href="{{url('profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ URL::asset('/assets/img/profiles/avatar-12.jpg')}}" alt="User Image"> Alex Campbell</a>
										</h2>
									</td>
								...
								<tr>
									<td>
										<h2 class="table-avatar">
											<a href="{{url('profile')}}"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ URL::asset('/assets/img/profiles/avatar-13.jpg')}}" alt="User Image"> Wendell Ward</a>
										</h2>
									</td>
