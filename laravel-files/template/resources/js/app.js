...
(function($) {
    ...
    $(document).on("click",".add-links",function () {
		var experiencecontent = '<div class="links-cont">' +
			'<div class="service-amount">' +
				'<a href="#" class="service-trash"><i class="fe fe-minus-circle ms-1"></i>Service Charge</a> <span>$ 4</span' +
			'</div>' +
		'</div>';
    ...
    $(document).on("click",".add-links-one",function () {
		var experiencecontent = '<div class="links-cont-discount">' +
			'<div class="service-amount">' +
				'<a href="#" class="service-trash-one"><i class="fe fe-minus-circle ms-1"></i>Offer new</a> <span>$ 4 %</span' +
			'</div>' +
		'</div>';
	 			...
	 			'<div class="row align-items-center ">' +
	 					...
	 					'<div class="row">' +
	 						...
	 						'<div class="col-lg-6 setting">' +
	 							'<label class="switch switch-one">' +
	 								'<a href="../template/index" class="layout-link"></a>' +
	 				...
	 				'<div class="col-xl-3 col-sm-6">' +
	 					...
	 					'<div class="row">' +
	 						...
	 						'<div class="col-lg-6 setting">' +
	 							'<label class="switch switch-one">' +
	 								'<a href="../template-rtl/index" class="layout-link"></a>' +
	 								'<span class="slider slider-one round"></span>' +
	 							'</label>' +
	 						'</div>' +
	 					'</div>' +
